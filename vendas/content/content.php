     ...
     <form>
       <div class="form-row">
         ...
         <div class="form-group col-md-6">
           ...
           <select class="form-control select2" data-live-search="true" id="cliente" name="cliente" placeholder="Selecione o cliente...">
         ...
         <form id="formCadastro">
           <div class="form-row" style="gap:10px">
             <div class="form-group col-md-3">
               ...
               <select class="form-control select2" data-live-search="true" id="produto" name="produto" placeholder="Selecione o produto...">
                 <option value="">Selecione...</option>
               </select>
             </div>
         ...
         <form id="formAtualizacao">
           <div class="form-row">
             <div class="fv-row form-group col-md-6">
               ...
               <select class="form-control select2" data-live-search="true" id="produto_update" name="produto_update" placeholder="Selecione o produto...">
                 <option value="">Selecione...</option>
               </select>
             </div>
             <div class="fv-row form-group col-md-6">
